                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          // Set edit mode and populate form with profile data
                          setIsEditMode(true);
                            ...
                            if (isEditMode && editingProfileId) {
                              ...
                              if (profileIndex !== -1) {
                                ...
                                if (activeProfile.id === editingProfileId) {
                                  setActiveProfile(profiles[profileIndex]);
                                }
                              }

                              // Here you would add the new profile to your profiles array
                              // For now, we'll just close the modal
                              //else block bearbeitet
                              } else {
